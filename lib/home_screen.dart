import 'package:eventvista/notification.dart';
import 'package:eventvista/splash_screen.dart';
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        title: Center(
          child: Text(
            ...
            style: TextStyle(
              ...
              fontWeight: FontWeight.bold, // Apply desired fontWeight
            ),
          ),
        ),
      ),
      ...
      body: Center(
        child: EventList(screenWidth: screenWidth, screenHeight: screenHeight),
      ),
